...
class Board:
    ...
    def put_token(self, row_index, col_index, player_color):
        if (self.boardstate[row_index][col_index] == LocType.EMPTY.value):
            self.boardstate[row_index][col_index] = player_color
        else:
    ...
    def start(self):
        ...
        while self.is_running == True:
            ...
            self.put_token(row_index, col_index, self.current_player.value)
            self.board_print()
